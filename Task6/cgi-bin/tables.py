...
def create_database_tables():
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS Zapis (
            ...
            FOREIGN KEY (PlanetID) REFERENCES Bilet(ID)
        )
    """)
...
def main():
    ...
    print("<div class=\"flex-div\"><table><tr><th colspan=\"4\">Bilet</th></tr><tr><th>ID</th><th>FIO</th><th>Age</th><th>Planet</th><th>Dop information</th></tr>")
    ...
    print("</table>")
    print("<table><tr><th colspan=\"2\">Date poleta</th></tr><tr><th>Planet ID</th><th>Data reliza</th></tr>")
    for release_row in releases:
        print(f"<tr><td>{release_row[1]}</td><td>{release_row[2]}</td></tr>")
    print("</table>")
    print("<table><tr><th colspan=\"2\">Planet</th></tr><tr><th>ID</th><th>Nazvanie</th></tr>")
