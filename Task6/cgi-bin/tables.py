...
def main():
    ...
    print("<div class=\"flex-div\"><table><tr><th colspan=\"4\">Билет</th></tr><tr><th>ID</th><th>ФИО</th><th>Возраст</th><th>Планета</th><th></th></tr>")
    ...
    print("</table>")
    print("<table><tr><th colspan=\"2\">Дата полета</th></tr><tr><th>Планета ID</th><th>Дата полета</th></tr>")
    for release_row in releases:
        print(f"<tr><td>{release_row[1]}</td><td>{release_row[2]}</td></tr>")
    print("</table>")
    print("<table><tr><th colspan=\"2\">Планета</th></tr><tr><th>ID</th><th>Галактика</th></tr>")
    ...
    print()
    print("<div class=\"flex-div\"><a href=\"load-json.py\">Таблицы в JSON</a></div>")
    print()
    print("</html>")
